...
/**
 * 基本通用 待完善
 * Created by DN on 2017/4/28.
 */

public class DnToolbar extends Toolbar {

    public DnToolbar(Context context) {
        super(context);
    }

    public DnToolbar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DnToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private OnLeftTitleClickListener mLeftTitleClickListener;
    private OnRightTitleClickListener mRightTitleClickListener;
    ...
    public void setOnLeftTitleClickListener(OnLeftTitleClickListener mLeftTitleClickListener) {
        this.mLeftTitleClickListener = mLeftTitleClickListener;
    }
    /**
     *  又边点击回调
     */
    ...
    public void setOnRightTitleClickListener(OnRightTitleClickListener mRightTitleClickListener) {
        this.mRightTitleClickListener = mRightTitleClickListener;
    }
    @Override
    protected void onFinishInflate() {
        ...
        mTvMainTitleLeft.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                mLeftTitleClickListener.onLeftClick(view);
            }
        });
        mTvMainTitleRight.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mRightTitleClickListener.onRightClick(view);
            }
        });
    }
    ...
    //设置title左边文字
    public void setMainTitleLeftText(int text) {
        mTvMainTitleLeft.setVisibility(View.VISIBLE);
        mTvMainTitleLeft.setText(text);
    }
    //设置title左边文字颜色
    ...
    //设置title右边文字
    public void setMainTitleRightText(int text) {
        mTvMainTitleRight.setVisibility(View.VISIBLE);
        mTvMainTitleRight.setText(text);
    }
    //设置title右边文字颜色
