...
import com.easy.common.baserx.RxManager;
...
public abstract class BaseActivity<T extends BasePresenter, E extends BaseModel> extends AutoLayoutActivity {
    ...
    public void initTitle() {
        mToolbar = (DnToolbar) findViewById(R.id.toolbar);
    ...
    private void doBeforeSetcontentView() {
        ...
        // 默认着色状态栏
        SetStatusBarColor();
//        QMUIStatusBarHelper.translucent(this,ContextCompat.getColor(this, R.color.main_color));
//        QMUIStatusBarHelper.translucent(this);
        if ( AppManager.getAppManager().currentActivity().getClass().getSimpleName().toString().equals("SplashActivity")){
            SetTranslanteBar();
//            QMUIStatusBarHelper.translucent(this);
        }
        if ( AppManager.getAppManager().currentActivity().getClass().getSimpleName().toString().equals("LoginActivity")){
            StatusBarCompat.setStatusBarColor(this, ContextCompat.getColor(this, R.color.login_title_color));
        }
        if ( AppManager.getAppManager().currentActivity().getClass().getSimpleName().toString().equals("RegisterActivity")){
            StatusBarCompat.setStatusBarColor(this, ContextCompat.getColor(this, R.color.login_title_color));
        }
    }
