...
public class CustomDialog extends Dialog {
    ...
    public static class Builder{
        ...
        public CustomDialog create(){
            CustomDialog dialog = new CustomDialog(this.P.mContext, P.mThemeResId);
         ...
         * @return
         */
        public Builder setImage(int viewId, String imgRes){//设置文本
            this.P.mStringImgArray.put(viewId,imgRes);
            return this;
        }
        /**
         * 设置指定view的显示隐藏功能
